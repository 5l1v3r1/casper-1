...
-[10]- IP Checker''')
    ...
    print (B+'''Gunakan dengan Bijak.!!
contact : ubaynakphe.i@gmail.com''')
...
''')
    ...
    if option:
        ...
        print R+'\nTidak ada pilihan! (harap cek ulang ketikkan anda!)\n' + W
        time.sleep(0.9)
        main()
